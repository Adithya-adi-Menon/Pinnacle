...
const BuyScreen3 = () => {
  return (
    ...
    >
      ...
      >
        ...
        <chakra.p mb="3" fontSize={{ base: "lg", md: "xl" }} color="#47586B">
            <Text> Thanks for purchasing. Your code is live at https://github.com/xyz . Please verify and release payment asap. </Text>
    ...
    <Center  pb={0} color={useColorModeValue("gray.700", "gray.600")}>
      ...
      <Center  pb={0} color={useColorModeValue("gray.700", "gray.600")}>
      <Text>Please verify your product from the seller before releasing the payment</Text>
      </Center>
              {/* <Flex>
