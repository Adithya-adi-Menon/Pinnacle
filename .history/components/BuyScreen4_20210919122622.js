    ...
    >
      <Box paddingLeft="150" paddingTop="70" w="100%" pr={{ md: 20 }}>
        ...
        <chakra.p mb="3" fontSize={{ base: "lg", md: "xl" }} color="#47586B">
          <Text>The transaction has been completed successfully. The seller has marked the received the payment and the transaction has been completed successfully.</Text>
